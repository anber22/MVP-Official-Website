  ...
  return (
    <div className="min-h-screen">
      <div className="px-[10dvw] py-10 md:py-30">
        ...
        <p>
          In order to better provide you with products and services offered on our Site, AI ProShots may collect personally identifiable information, such as your:
          First and Last Name
        </p>
        <p>
          Mailing Address
        ...
        <p className="mb-[20px]"> 
          If you purchase AI ProShots's products and services, we collect billing and credit card information. This information is used to complete the purchase transaction.
          Please keep in mind that if you directly disclose personally identifiable information or personally sensitive data through AI ProShots's public message boards, this information may be collected and used by others.
        </p>
        <p>......</p>
      </div>
    </div>
